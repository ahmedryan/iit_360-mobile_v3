...
class RescheduleClassScreen extends StatefulWidget {
  static const routeName = '/reschedule-class';
...
class _RescheduleClassScreenState extends State<RescheduleClassScreen> {
  ...
  _submit() {
    ...
    var modifiedPreviousDate = _previousDate.toIso8601String().substring(0, 10);
    var modifiedNewDate = _newDate.toIso8601String().substring(0, 10);
    ...
    Provider.of<RoutineProvider>(context, listen: false)
        .rescheduleClass(modifiedCourseCode, modifiedPreviousDate,
            modifiedNewDate, modifiedBeginTime, modifiedEndTime)
        .catchError((err) {
      return showDialog<Null>(
        context: context,
        builder: (ctx) => AlertDialog(
                          ...
                          child: Form(
                            ...
                            child: ListView(
                              children: [
                                ...
                                ListTile(
                                  title: Text(
                                    DateFormat.yMMMMEEEEd()
                                        .format(_previousDate),
                                  ),
                                  subtitle: Text('Previous Date'),
                                  trailing: Icon(
                                    Icons.date_range,
                                    color: Colors.deepPurple,
                                  ),
                                  onTap: () {
                                    _pickPreviousDate(context);
                                  },
                                ),
                                Divider(
                                  thickness: 1.0,
                                ...
                                ListTile(
                                  title: Text(
                                    DateFormat.yMMMMEEEEd().format(_newDate),
                                  ),
