          ...
          if (dataSnapshot.connectionState == ConnectionState.waiting) {
            ...
            return Consumer<NoticeProvider>(
              builder: (ctx, noticeProvider, _) {
                return noticeProvider.projectNotice!.length == 0
                    ? Center(
                        child: Text('No Notices Available...'),
                      )
                    : ListView.builder(
                        itemCount: noticeProvider.projectNotice!.length,
                        shrinkWrap: true,
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Padding(
                                          padding: const EdgeInsets.all(8.0),
                                          child: Text(
                                            noticeProvider.projectNotice![index]
                                                .noticeSection,
                                            style: TextStyle(
                                        ...
                                        Text(
                                          noticeProvider
                                              .projectNotice![index].noticeDate
                                              .toIso8601String(),
                                        ),
                                        Text(
                                          noticeProvider
                                              .projectNotice![index].noticeTime,
                                        ),
                                      ],
                                    ),
                                  ),
