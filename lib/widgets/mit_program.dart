...
class MitProgram extends StatelessWidget {
  @override
            ...
            return Consumer<AcademicProvider>(
              builder: (ctx, academicProvider, _) {
                return ListView.builder(
                  itemCount: academicProvider.gradProgramMit!.length,
                  shrinkWrap: true,
                        ...
                        child: Column(
                          ...
                          children: [
                            Center(
                              child: Text(
                                academicProvider
                                    .gradProgramMit![index].academicProgram,
                                style: TextStyle(fontWeight: FontWeight.bold),
                              ),
                            ),
                            Visibility(
                              visible: academicProvider.gradProgramMit![index]
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text(academicProvider.gradProgramMit![index]
                                      .academicInformation),
                                ],
                              ),
                            ),
